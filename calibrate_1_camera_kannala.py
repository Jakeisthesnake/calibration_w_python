...
def compute_homographies(obj_pts_list, img_pts_list):
    """Compute homographies for all calibration images using Direct Linear Transformation (DLT)."""
    homographies = []
...
def fisheye_reprojection_error(params, obj_pts_list, img_pts_list, num_images):
    ...
    for i in range(num_images):
        ...
        projected_pts = kannala_brandt_project(transformed_pts, K, dist_coeffs)
...
def calibrate_fisheye_camera(data_file):
    ...
    """
    obj_pts_list, img_pts_list = process_csv(data_file, target_cam_id=1)
    print("Checkpoint\n")
    # print("obj_pts_list\n", obj_pts_list)
    # print("img_pts_list\n", img_pts_list)
    ...
    H_list = compute_homographies(obj_pts_list, img_pts_list)
    # print("H_list\n", H_list)
    print("Checkpoint2\n")
    # print("H_list\n", H_list)
    ...
    intrinsic_refined, dist_coeffs_refined, rvecs_refined, tvecs_refined = optimize_fisheye_parameters(
        K, dist_coeffs, rvecs, tvecs, obj_pts_list, img_pts_list
    )
